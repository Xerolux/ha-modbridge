...
![Version](https://img.shields.io/badge/version-v2.0.10.20-blue) ![License](https://img.shields.io/github/license/Xerolux/ha-modbridge.svg?style=flat-square)
...
> **Version:** v2.0.10.20 — diese Integration wird automatisch mit der Version des Original-ModBridge synchronisiert ([Sync-Workflow](.github/workflows/sync-version.yml)).
...
**Version:** v2.0.10.20 — kept in lockstep with upstream ModBridge via a daily sync workflow.
