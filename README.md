...
![Version](https://img.shields.io/badge/version-v3.0.0-blue) ![License](https://img.shields.io/github/license/Xerolux/ha-modbridge.svg?style=flat-square)
...
> **Version:** v3.0.0 — diese Integration wird automatisch mit der Version des Original-ModBridge synchronisiert ([Sync-Workflow](.github/workflows/sync-version.yml)).
...
**Version:** v3.0.0 — kept in lockstep with upstream ModBridge via a daily sync workflow.
